...
def load_model(weights_path, device):
    ...
    try:
        # map_locationを使うことで、GPUで学習したモデルをCPUしか無い環境でもロード可能にします
    ...
    model.to(device)
    model.eval() # ★超重要：評価モードにする（DropoutやBatch Normを固定）
    return model
...
def preprocess_image(image_path):
    ...
    try:
        ...
        input_batch = input_tensor.unsqueeze(0) # バッチ次元を追加 [3, 224, 224] -> [1, 3, 224, 224]
        return input_batch
    except Exception as e:
